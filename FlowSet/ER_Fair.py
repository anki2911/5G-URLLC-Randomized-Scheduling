...
def main():
    ...
    for i in range(0,n_alloc):        
        ...
        for num in range(0,n_flowsets):
                ...
                for time in range(1,hyperperiod+1):
                    for flow in range(0,num_of_flows):
                        if time in Pseudo_deadline[flow]:
                            ...
                            #Early Release
                            if index%2 == 0:
                                Release_time[flow][index+1] = slot_no + 1
                del Release_time
                del Pseudo_deadline
                del Utilized_slots 
            ...
            f = open("../SCS_" + str(SCS) + "/Allocation_" + str(alpha) + "/Random_ER_" + str(Util_min) + "_" + str(Util_max) + "_" + str(n_subbands) + "/Prob_" + str(i+1) + "_" + str(num+1) + ".txt", "w")
            #f = open("Rough_EDF/Prob_ER_" + str(i+1) + "_" + str(num+1) + ".txt", "w")
