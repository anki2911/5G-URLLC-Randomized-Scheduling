...
def main():
    ...
    div = open("Divergence_EDF_" + str(Util_min) + "_" + str(Util_max) + "_" + str(n_subbands) + "_" + str(alpha) + "_" + str(SCS) + ".txt","w")
    ...
    for i in range(0,n_alloc):
        ...
        for j in range(0,n_flowsets):
            ...
            c = open("../SCS_" + str(SCS) + "/Allocation_" + str(alpha) + "/EDF_" + str(Util_min) + "_" + str(Util_max) + "_" + str(n_subbands) + "/Prob_" + str(i+1) + "_" + str(j+1) + ".txt","r")
            #c = open("Rough_EDF/Prob_1_1.txt","r")
                    ...
                    for minislots in range(0,10*SCS):
                        for flows in range(0,num_of_flows):
                            if Prob[j][frames][n_bands][minislots][flows] > 0.0:
                                ...
                                #print Prob[j][frames][n_bands][minislots][flows]
