...
def main():
    ...
    div = open("Divergence_PF_" + str(Util_min) + "_" + str(Util_max) + "_" + str(n_subbands) + "_" + str(alpha) + "_" + str(SCS) + ".txt","w")
    ...
    for i in range(0,n_alloc):
        ...
        for j in range(0,n_flowsets):
            ...
            c = open("../SCS_" + str(SCS) + "/Allocation_" + str(alpha) + "/Random_PF_" + str(Util_min) + "_" + str(Util_max) + "_" + str(n_subbands) + "/Prob_" + str(i+1) + "_" + str(j+1) + ".txt","r")
            #c = open("Rough_EDF/Prob_ER_1_1.txt","r")
